...
Source0:	http://ppa.launchpad.net/chromium-daily/stable/ubuntu/pool/main/c/chromium-browser/%{name}_%{version}~r%{svnver}.orig.tar.gz
# Source0-md5:	83da52a6f862809482246e6c2c570189
Source2:	%{name}.sh
